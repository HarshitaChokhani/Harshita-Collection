...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Premium Indian boutique — suits, kurtis, sarees, dupattas, and more. Complimentary shipping across India." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Harshita Collection — Elegance in Every Thread" },
      { name: "twitter:description", content: "Premium Indian boutique — suits, kurtis, sarees, dupattas, and more. Complimentary shipping across India." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1045516e-9993-40a8-aaa7-d9a1af24bd9b/id-preview-84bf60a3--46557760-4655-4698-b086-c3a019959b54.lovable.app-1781370430239.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1045516e-9993-40a8-aaa7-d9a1af24bd9b/id-preview-84bf60a3--46557760-4655-4698-b086-c3a019959b54.lovable.app-1781370430239.png" },
    ],
    links: [
